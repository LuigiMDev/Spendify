  ...
  return (
    <>
      ...
      <div
        ...
        } w-screen h-screen bg-black fixed top-0 left-0 transition-all durations 300 lg:hidden z-40`}
        onClick={handleMenu}
      ></div>
      ...
      <div
        ...
        } left-full bg-white h-screen shadow-header top-0 transition-all duration-500 pt-24 w-[80vw] md:w-[50vw] lg:hidden px-5 z-40 flex`}
      >
